...
if (!isDedicated) then {
	...
	//self actions moved to new_conf
	//fnc_usec_selfActions =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_selfActions.sqf";		
	// D7 Ver //
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "new_conf\fn_selfActions.sqf"; //Checks which actions for self
	// D7 Ver //
	...
	local_lockUnlock =			compile preprocessFileLineNumbers "new_cmd\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
